...
#define DEBUG_BLE				DEBUG_LEVEL_LOW
#define DEBUG_SSL				DEBUG_LEVEL_CLOSE
 ...
 * @return[out] None
 * @see None.
 * @note will use mutex in this function, if you want print in ISR please use 'HF_Debug_ISR'.
 */
