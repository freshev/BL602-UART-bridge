...
int HSF_IAPI hfsys_is_run_hfsw(void);
 ...
 * @return[out] 
 * ================================================================================================
 * | HFSYS_RESET_REASON_NORMAL             | 'power off' or 'reset button'                        |
 * |----------------------------------------------------------------------------------------------|
 * | HFSYS_RESET_REASON_ERESET             | 'hardware watchdog' or 'unknown resason'             |
 * |----------------------------------------------------------------------------------------------|
 ...
 * @note None.
 */
void HSF_API *hfmem_realloc(void *pv, int size);
...
/**
 * @brief register system callback function which will be called when system happen the follow cases.
 * ==========================================
