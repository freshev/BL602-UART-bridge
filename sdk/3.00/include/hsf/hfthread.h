...
int HSF_IAPI hfthread_init(void);
 ...
 * @note None.
 */
uint32_t HSF_API hfthread_get_current_taskid(void);

/**
 * @brief get thread name by taskid.
 *
 * @param[in] taskid: the thread taskid
 * @return[out] the name of thread
 * @see None.
 * @note None.
 */
char *HSF_API hfthread_get_name_by_taskid(uint32_t taskid);
