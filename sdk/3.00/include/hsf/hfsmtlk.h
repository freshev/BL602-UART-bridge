...
#define SMTLK_STATE_BTLINK			8
#define SMTLK_STATE_APBTLINK		9
#define SMTLK_STATE_WPS		10
#define SMTLK_STATE_FIND			11
#define SMTLK_STATE_FINISHED		12
#define SMTLK_STATE_FAILED			13
...
uint8_t HSF_IAPI hfsmtlk_init(void);

int HSF_IAPI hfsmtlk_main_loop(void);
...
int HSF_IAPI hfsmtlk_send_log(void);
 ...
 * @note None.
 */
PWIFI_SCAN_RESULT_ITEM HSF_IAPI hfsmtlk_list_find_ap_by_ssid(uint8_t *ssid, uint8_t ssid_len);
