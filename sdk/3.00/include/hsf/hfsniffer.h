...
#define HFSNIFFER_RECE_MODE_ALL_DATA				0x00FF
 ...
 * |----------------------------------------|
 * | HFSNIFFER_RECE_MODE_ALL_DATA           |
 * ==========================================
 *			 cb: a function pointer, called back when wifi receive a frame, 'pkt' in callback function may be NULL
...
/**
 * @brief register a callback function which will be called when wifi receive a frame.
 *
 * @param[in] cb: a function pointer, called back when wifi receive a frame, 'pkt' in callback function may be NULL
 * @return[out] HF_SUCCESS-successfully, other value is failed
 * @see None.
 * @note None.
 */
int HSF_API hfsniffer_register(hfsniffer_recv_callback_t cb);
