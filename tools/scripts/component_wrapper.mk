...
# COMPONENT_MAKEFILE is set to point at the Makefile.mk file for the component itself,
...
# Some of the following defaults may be overriden by the component's Makefile.mk makefile,
...
################################################################################
# 2) Include the Makefile.mk for the specific component (COMPONENT_MAKEFILE) to
...
# Include Makefile.mk for this component.
-include $(PROJECT_SDK_PATH)/tools/scripts/project_val.mk
...
$(subst $(PROJECT_SDK_PATH),$$(PROJECT_SDK_PATH),$(subst $(PROJECT_PATH),$$(PROJECT_PATH),$(subst $(BUILD_DIR_BASE),$$(BUILD_DIR_BASE),$(1))))
endef
...
################################################################################
# 3) Set variables that depend on values that may changed by Makefile.mk
################################################################################
...
# ie put literal $(PROJECT_SDK_PATH), $(PROJECT_PATH) and $(BUILD_DIR_BASE) into the generated
...
# take Makefile.mk variables COMPONENT_ADD_INCLUDEDIRS,
...
# is not set by Makefile.mk, define default build, clean, etc. targets
#
# (Skipped if COMPONENT_CONFIG_ONLY is set.)
################################################################################
...
component_project_vars.mk::  # no need to add variables via Makefile.mk
